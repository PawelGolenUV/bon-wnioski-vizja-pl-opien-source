...
//        return ' border-3 bg-blue-600 font-medium inline-block px-4 py-2 relative rounded-full text-white text-sm whitespace-nowrap w-fit dark:bg-yellow-400 dark:text-black dark:hover:bg-yellow-300 hover:bg-blue-700 lg:px-5 lg:py-2.5 ';
        return '
                cursor-pointer
