...
class MyAzureAuthenticator extends OAuth2Authenticator implements AuthenticationEntrypointInterface
{
    ...
    public function __construct(
        ...
        RouterInterface $router, GraphTokenSession $graphTokenSession, HttpClientInterface $httpClient, GraphTokenManager $graphTokenManager, StudentManager $studentManager, TranslatorInterface $translator,
    ) {
...
//                        throw new CustomUserMessageAuthenticationException($this->translator->trans('Konto Office 365 nie jest powiązane z Verbisem'));
//                    }
