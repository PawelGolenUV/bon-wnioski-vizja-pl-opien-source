...
class ApplicationController extends AbstractController
{
     ...
     */
    #[Route('/wniosek/dodaj/krok/1', name: 'student_choose_application_type')]
    #[IsGranted('ROLE_STUDENT')]
     ...
     */
    #[Route('/wniosek/dodaj/krok/1/wybierz-adaptacje', name: 'student_choose_adaptation')]
    #[IsGranted('ROLE_STUDENT')]
...
//                $this->applicationManager->clearSession();
     ...
     * @return Response Widok formularza wyboru typu lub przekierowanie do kolejnego kroku
     */
    #[Route('/wniosek/dodaj/krok/1b/wybierz-typ-wniosku', name: 'student_choose_application_type_b')]
    #[IsGranted('ROLE_STUDENT')]
     ...
     * @throws Throwable
     */
    #[Route('/wniosek/dodaj/krok/2', name: 'student_fill_application_form')]
    #[IsGranted('ROLE_STUDENT')]
...
//                extensionsMessage: 'Plik musi mieć rozszerzenie PDF',
            ...
            foreach (['decision', 'schedule', 'statement', 'files'] as $fieldName) {
                ...
                foreach ($form->get($fieldName)->getData() ?? [] as $fileEntity) {
                    ...
                    $application->files->add($fileEntity);
     ...
     */
    #[Route('/wniosek/dodaj/krok/3', name: 'student_send_application_form')]
    #[IsGranted('ROLE_STUDENT')]
     ...
     * @throws SyntaxError
     */
    #[Route('/wniosek/dodaj/krok/4', name: 'student_show_application_summary')]
    #[IsGranted('ROLE_STUDENT')]
     ...
     */
    #[Route('/wniosek/pobierz-plik/{fileId}', name: 'student_application_file_download')]
    #[IsGranted('ROLE_STUDENT')]
     ...
     */
    #[Route('/wniosek/wyswietl-plik/{fileId}', name: 'student_application_file_show')]
    #[IsGranted('ROLE_STUDENT')]
     ...
     */
    #[Route('/wniosek/szczegoly/{applicationId}', name: 'student_application_details')]
    #[IsGranted('ROLE_STUDENT')]
     ...
     * @throws Exception
     */
    #[Route('/wniosek/plik/{fileId}/usun', name: 'student_application_file_delete', methods: ['DELETE', 'POST'])]
    #[IsGranted('ROLE_STUDENT')]
    public function deleteApplicationFile(string $fileId, Request $request): JsonResponse
    {
        ...
        if ($file->application->student->id !== $this->getUser()->id) {
            throw new Exception('Plik nie należy do ciebie');
        }
    ...
    #[Route('/wniosek/plik/upload/{category2}', name: 'student_application_file_upload', methods: ['POST'])]
    #[IsGranted('ROLE_STUDENT')]
    public function uploadApplicationFile(Request $request, string $category): JsonResponse
    {
        $application = $this->applicationManager->getApplicationFromSession();
