...
class RegistrationRepository extends ServiceEntityRepository
{
     ...
     * @return int
     */
//    public function incrementRegistered(string $registrationId): int
//    {
//        return $this->createQueryBuilder('r')
//            ->update()
//            ->set('r.registered', 'r.registered + 1')
//            ->where('r.id = :id')
...
//    }
     ...
     * @return int
     */
//    public function decrementRegistered(string $registrationId): int
//    {
//        return $this->createQueryBuilder('r')
//            ->update()
//            ->set('r.registered', 'CASE WHEN r.registered > 0 THEN r.registered - 1 ELSE 0 END')
//            ->where('r.id = :id')
//            ->setParameter('id', $registrationId)
//            ->getQuery()
//            ->execute();
