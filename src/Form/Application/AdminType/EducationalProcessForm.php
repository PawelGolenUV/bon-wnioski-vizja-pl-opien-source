...
// sortuj alfabetycznie po nazwie
        ...
        $builder
            ->add('albumNumber', IntegerType::class, [
                ...
                'attr' => ['min' => 0],
                'constraints' => [
                    new NotBlank(['message' => $this->translator->trans('Wpisz numer albumu')]),
                    new Positive(),
                    new Range(['min' => 1]),
                ],
            ])
            ...
            ->add('studyMode', EntityType::class, [
                ...
                'choice_label' => 'value',
                'constraints' => [
                    new NotBlank(['message' => $this->translator->trans('Wybierz tryb studiów')]),
                ],
            ])
            ...
            ->add('year', EntityType::class, [
                ...
                'choice_label' => 'value',
                'constraints' => [
                    new NotBlank(['message' => $this->translator->trans('Wybierz rok studiów')]),
                ],
            ])
...
//                'choice_label' => 'value',
//                'constraints' => [
//                    new NotBlank(['message' => $this->translator->trans('Wybierz semestr studiów')]),
//                ],
//            ])
            ...
            ->add('faculty', EntityType::class, [
                ...
                'choice_label' => 'value',
                'constraints' => [
                    new NotBlank(['message' => $this->translator->trans('Wybierz swój kierunek studiów')]),
                ],
            ])
